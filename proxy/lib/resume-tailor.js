...
Rules:
1. This resume is perfect, its layout and everything is good. Just change it to make it ATS friendly to the provided job description.
2. Optimize the resume for this specific job by using its ATS keywords.
3. Don't change much. Keep changes minimal.
4. For any bullet point or section you rewrite, the word count should be n or n-1 (exactly the same as the original, or exactly one word less).
5. Output valid, compilable LaTeX representing the entire document.`
    },
    {
      role: "user",
