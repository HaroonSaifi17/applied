...
const FACT_ALIASES = {
  ...
  email: ["email", "email address", "mail", "work email", "personal email"],
  phone: ["phone", "phone number", "mobile", "contact number", "cell phone", "cell number"],
  linkedInUrl: ["linkedin", "linkedin url", "linkedin profile"],
  githubUrl: ["github", "github url", "github profile"],
  websiteUrl: ["website", "portfolio", "portfolio url", "personal site", "personal website", "homepage"],
  twitterUrl: ["twitter", "x profile", "x.com", "twitter url", "x url"],
  leetcodeUrl: ["leetcode", "leetcode profile", "leetcode url"],
  location: ["location", "current location", "where are you based"],
  address: ["address", "street address", "full address", "home address"],
  city: ["city", "current city", "town"],
  state: ["state", "province", "region"],
  country: ["country", "nation"],
  nationality: ["nationality", "national"],
  workAuthorization: ["work authorization", "authorized to work", "work permit", "eligible to work", "legally authorized"],
  needsSponsorship: ["visa sponsorship", "need sponsorship", "require sponsorship", "visa status"],
  salaryExpectation: ["salary expectation", "expected salary", "expected ctc", "compensation", "desired salary", "pay expectation"],
  currentCTC: ["current ctc", "current salary", "current compensation", "current pay"],
  noticePeriod: ["notice period", "availability", "when can you start", "start date", "available to start", "earliest start date"],
  willingToRelocate: ["willing to relocate", "relocate", "relocation"],
  currentCompany: ["current company", "current employer", "present company", "where do you work"],
  currentRole: ["current role", "job title", "current title", "designation"],
  experienceLevel: ["professional experience", "experience level", "experience level"],
  freelanceExperience: ["freelance experience", "freelance", "freelancing"],
  graduationYear: ["graduation year", "year of graduation", "passing year", "expected graduation"],
  degree: ["degree", "highest degree", "qualification", "degree type", "degree earned", "education level"],
  educationLevel: ["education level", "highest education", "highest level of education"],
  university: ["university", "college", "institution", "school", "education institution"],
  cgpa: ["cgpa", "gpa", "grade point average", "academic performance"],
  education: ["education"],
  employmentType: ["employment type", "work type", "job type"],
  totalExperience: ["total experience", "overall experience", "years of experience", "professional experience", "how many years"],
  ...
  llmExperience: ["llm experience", "ai experience", "llm api experience", "artificial intelligence experience"],
  technicalSkills: ["technical skills", "skills", "tech stack", "technologies"],
  languages: ["languages", "spoken languages", "language proficiency", "language skills"],
  fresherStatus: ["fresher status", "fresher", "new graduate", "recent graduate", "entry level"],
  achievements: ["achievements", "awards", "honors", "accomplishments"],
  projects: ["projects", "key projects", "notable projects", "project highlights"],
  aboutYou: ["about you", "about yourself", "bio", "summary", "tell me about yourself", "introduce yourself", "short bio"],
  strengths: ["strengths", "core strengths", "your strengths"],
  weaknesses: ["weaknesses", "your weaknesses", "areas for improvement"],
  whyHireYou: ["why hire you", "why should we hire you", "why are you a good fit"],
